...
(*.[0-9]*)
	...
	if test ! -f /home/BlackBIrdz/cpp_arcade/lib/ncurses-6.1/man_alias.sed ; then
cat >>/home/BlackBIrdz/cpp_arcade/lib/ncurses-6.1/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/BlackBIrdz/cpp_arcade/lib/ncurses-6.1/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/BlackBIrdz/cpp_arcade/lib/ncurses-6.1/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /home/BlackBIrdz/cpp_arcade/lib/ncurses-6.1/man_alias.sed \
		< $i >$TMP
